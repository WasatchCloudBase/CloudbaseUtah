...
struct MapViewRepresentable: UIViewRepresentable {
    ...
    func updateUIView(_ mapView: MKMapView, context: Context) {
        ...
        // Draw new polylines
        for (_, coordinates) in trackLines {
...
struct MapView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Create map
//            MapViewRepresentable(region: $region, trackLines: pilotTracksViewModel.getTrackLines())
                ...
                MapAnnotation(coordinate: CLLocationCoordinate2D(latitude: annotation.coordinates.latitude, longitude: annotation.coordinates.longitude)) {
                    ...
                    Button(action: {
                        ...
                        case "pilot" :
                            ...
                            VStack (spacing: 0) {
                                Image(systemName: pilotAnnotationImage)
                                ...
                                .padding (4)
                                .frame(width: pilotNodeAnnotationTextWidth, height: pilotLabelHeight)
